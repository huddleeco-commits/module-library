/**
 * cafeproducutiontest1 - Our Baristas Page
 */
  ...
  return (
    <div style={styles.container}>
      <section style={styles.hero}>
        ...
        <p style={styles.subtitle}>Meet the people behind cafeproducutiontest1</p>
      </section>
...
const styles = {
  ...
  card: { background: '#fff', padding: '27px', borderRadius: '9px', boxShadow: '0 4px 15px rgba(0,0,0,0.08)', textAlign: 'center' },
