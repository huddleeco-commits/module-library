/**
 * cafeproducutiontest1 - Gallery Page
 */
  ...
  return (
    <div style={styles.container}>
      <section style={styles.hero}>
        ...
        <p style={styles.subtitle}>A glimpse into cafeproducutiontest1</p>
      </section>
...
const styles = {
  ...
  imageCard: { borderRadius: '9px', overflow: 'hidden', boxShadow: '0 4px 15px rgba(0,0,0,0.08)' },
