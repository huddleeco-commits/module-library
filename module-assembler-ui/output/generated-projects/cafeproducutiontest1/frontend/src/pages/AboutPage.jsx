/**
 * cafeproducutiontest1 - About Page
 */
  ...
  return (
    <div style={styles.container}>
      <section style={styles.hero}>
        <h1 style={styles.title}>About cafeproducutiontest1</h1>
      ...
      <section style={styles.story}>
        ...
        <p style={styles.text}>
          For 5 years, cafeproducutiontest1 has been dedicated to providing exceptional
...
const styles = {
  ...
  story: { padding: '67px 24px', maxWidth: '800px', margin: '0 auto', textAlign: 'center' },
  ...
  values: { padding: '67px 24px', background: '#f8fafc' },
  valueGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '24px', maxWidth: '1200px', margin: '0 auto' },
  valueCard: { background: '#ffffff', padding: '27px', borderRadius: '9px', boxShadow: '0 4px 15px rgba(0,0,0,0.08)', textAlign: 'center' }
};
