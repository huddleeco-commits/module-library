/**
 * cafeproducutiontest1 - Home Page
    ...
    <div style={styles.container}>
      ...
      <section style={styles.hero}>
        <div style={styles.heroContent}>
          <h1 style={styles.heroTitle}>Welcome to cafeproducutiontest1</h1>
      ...
      <section style={styles.aboutPreview}>
        <h2 style={styles.sectionTitle}>About cafeproducutiontest1</h2>
        <p style={styles.aboutText}>For 5 years, cafeproducutiontest1 has been serving our community with dedication and excellence.</p>
...
const styles = {
  ...
  aboutPreview: { padding: '67px 24px', textAlign: 'center', maxWidth: '800px', margin: '0 auto' },
  sectionTitle: {
    fontSize: '2rem',
    fontWeight: '600',
    fontFamily: 'Poppins, sans-serif',
  ...
  testimonials: { padding: '67px 24px', background: '#f8fafc' },
  testimonialGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '24px', maxWidth: '1200px', margin: '0 auto' },
  testimonialCard: { background: '#ffffff', padding: '27px', borderRadius: '9px', boxShadow: '0 4px 15px rgba(0,0,0,0.08)' },
  ...
  ctaSection: { padding: '67px 24px', textAlign: 'center', background: 'linear-gradient(135deg, #6366f1 0%, #06b6d4 100%)' },
