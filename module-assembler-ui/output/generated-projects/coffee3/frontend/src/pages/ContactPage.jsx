...
const styles = {
  ...
  form: { background: '#f8fafc', padding: '22px', borderRadius: '7px' },
  input: { width: '100%', padding: '14px', marginBottom: '16px', border: '1px solid #e2e8f0', borderRadius: '7px', fontSize: '16px' },
  textarea: { width: '100%', padding: '14px', marginBottom: '16px', border: '1px solid #e2e8f0', borderRadius: '7px', fontSize: '16px', resize: 'vertical' },
  button: { width: '100%', padding: '14px', background: '#6366f1', color: '#fff', border: 'none', borderRadius: '6px', fontSize: '16px', fontWeight: '600', cursor: 'pointer' }
};
