  ...
  return (
    <div style={styles.container}>
      <section style={styles.hero}>
        ...
        <p style={styles.subtitle}>What's happening at coffee3</p>
      </section>
...
const styles = {
  ...
  card: { display: 'flex', gap: '24px', background: '#fff', padding: '22px', borderRadius: '7px', boxShadow: '0 4px 15px rgba(0,0,0,0.08)', marginBottom: '20px' },
  dateBox: { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px', padding: '16px', background: '#6366f110', borderRadius: '7px' },
  details: { flex: 1 },
