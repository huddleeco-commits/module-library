-- Loyalty Program Schema for ShermPoints
-- PostgreSQL
...
INSERT INTO users (email, password_hash, name, is_admin, referral_code) VALUES ('huddleeco@gmail.com', '$2a$10$QzrdYJOTzjyk/VAA5g.zYu0xrqgWKBLxP2J0T7RxpdkZsK650cAPW', 'Admin', true, 'ADMIN001') ON CONFLICT (email) DO NOTHING;
