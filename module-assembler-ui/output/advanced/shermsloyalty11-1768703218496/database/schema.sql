-- Loyalty Program Schema for ShermsLoyalty11
-- PostgreSQL
...
-- Insert admin user
INSERT INTO users (email, password_hash, name, is_admin, referral_code) VALUES ('admin@shermsloyalty11.com', '$2b$10$example', 'Admin', true, 'ADMIN001') ON CONFLICT (email) DO NOTHING;
