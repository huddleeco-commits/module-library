...
const styles = {
  ...
  orderOptions: { padding: '24px', textAlign: 'center', borderBottom: '1px solid #d1d5db' },
  optionBtns: { display: 'flex', gap: '12px', justifyContent: 'center', marginBottom: '12px' },
  optionBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', border: '2px solid #d1d5db', borderRadius: '8px', background: '#ffffff', cursor: 'pointer', fontWeight: '500', color: '#1f2937' },
  optionActive: { borderColor: '#8B4513', background: '#8B4513', color: '#fff' },
  infoText: { color: '#4b5563', fontSize: '0.9rem' },
  ...
  menu: {},
  sectionTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.5rem', fontWeight: '600', color: '#1f2937', marginBottom: '24px' },
  menuGrid: { display: 'flex', flexDirection: 'column', gap: '12px' },
  menuCard: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#ffffff', padding: '16px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  menuInfo: {},
  menuName: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontWeight: '600', color: '#1f2937', marginBottom: '2px' },
  menuCategory: { color: '#4b5563', fontSize: '0.85rem', marginBottom: '4px' },
  ...
  cartSection: { background: '#ffffff', padding: '24px', borderRadius: '8px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', height: 'fit-content', position: 'sticky', top: '24px' },
  emptyCart: { color: '#4b5563', textAlign: 'center', padding: '32px 0' },
  cartItem: { padding: '12px 0', borderBottom: '1px solid #d1d5db' },
  cartInfo: { display: 'flex', justifyContent: 'space-between', marginBottom: '8px' },
  cartName: { fontWeight: '500', color: '#1f2937' },
  cartPrice: { color: '#8B4513', fontWeight: '600' },
  cartControls: { display: 'flex', alignItems: 'center', gap: '12px' },
  qtyBtn: { width: '28px', height: '28px', borderRadius: '50%', border: '1px solid #d1d5db', background: '#f0f0f0', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#1f2937' },
  qty: { fontWeight: '600', color: '#1f2937' },
  cartTotal: { display: 'flex', justifyContent: 'space-between', padding: '16px 0', fontWeight: '600', fontSize: '1.1rem', color: '#1f2937' },
  ...
  callOption: { marginTop: '24px', textAlign: 'center', paddingTop: '24px', borderTop: '1px solid #d1d5db' },
  callText: { color: '#4b5563', marginBottom: '8px', fontSize: '0.9rem' },
