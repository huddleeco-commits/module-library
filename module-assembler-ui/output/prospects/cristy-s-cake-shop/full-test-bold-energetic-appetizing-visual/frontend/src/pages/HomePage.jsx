...
const styles = {
  ...
  specials: { padding: '60px 20px' },
  container: { maxWidth: '1100px', margin: '0 auto', padding: '0 24px' },
  sectionHeader: { textAlign: 'center', marginBottom: '48px' },
  sectionTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#1f2937', marginBottom: '12px' },
  sectionTitleCenter: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#1f2937', textAlign: 'center', marginBottom: '48px' },
  sectionSubtitle: { color: '#4b5563', fontSize: '1.1rem' },
  specialsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '28px' },
  specialCard: { background: '#ffffff', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' },
  specialImage: { width: '100%', height: '200px', objectFit: 'cover' },
  specialInfo: { padding: '20px' },
  specialName: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.25rem', fontWeight: '600', color: '#1f2937', marginBottom: '8px' },
  specialDesc: { color: '#4b5563', marginBottom: '12px', lineHeight: 1.5 },
  ...
  story: { padding: '60px 20px', background: '#e5e5e5' },
  ...
  storyImage: { width: '100%', borderRadius: '8px', boxShadow: '0 10px 40px rgba(0,0,0,0.15)' },
  storyContent: {},
  storyTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#1f2937', marginBottom: '20px' },
  storyText: { color: '#4b5563', lineHeight: 1.8, marginBottom: '16px', fontSize: '1.05rem' },
  ...
  reviewCard: { background: '#ffffff', padding: '28px', borderRadius: '8px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' },
  stars: { display: 'flex', gap: '4px', marginBottom: '16px' },
  reviewText: { color: '#1f2937', lineHeight: 1.7, marginBottom: '16px', fontStyle: 'italic' },
  reviewAuthor: { color: '#4b5563', fontWeight: '500' },
