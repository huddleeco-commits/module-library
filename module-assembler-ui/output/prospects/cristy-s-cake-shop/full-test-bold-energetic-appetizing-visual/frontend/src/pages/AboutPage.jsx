...
const styles = {
  ...
  values: { padding: '60px 20px', background: '#e5e5e5' },
  valuesGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '32px' },
  valueCard: { background: '#ffffff', padding: '32px', borderRadius: '8px', textAlign: 'center', boxShadow: '0 4px 20px rgba(0,0,0,0.06)' },
  valueTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.25rem', fontWeight: '600', color: '#1f2937', margin: '16px 0 8px' },
  valueDesc: { color: '#4b5563', lineHeight: 1.6 },
