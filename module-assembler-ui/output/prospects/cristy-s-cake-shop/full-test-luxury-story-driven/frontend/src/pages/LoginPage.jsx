...
const styles = {
  page: { minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', background: '#0d0d0f' },
  card: { width: '100%', maxWidth: '420px', background: '#1a1a1f', borderRadius: '16px', padding: '40px', boxShadow: '0 4px 20px rgba(0,0,0,0.3)' },
  header: { textAlign: 'center', marginBottom: '32px' },
  title: { fontSize: '24px', fontWeight: '700', color: '#f5f5f0', marginTop: '16px', marginBottom: '8px' },
  ...
  label: { fontSize: '14px', fontWeight: '500', color: '#f5f5f0' },
  ...
  submitBtn: { padding: '14px', background: '#d4af37', color: '#fff', border: 'none', borderRadius: '16px', fontSize: '16px', fontWeight: '600', cursor: 'pointer' },
  footerText: { textAlign: 'center', marginTop: '24px', fontSize: '14px', color: '#f5f5f0', opacity: 0.7 },
  link: { color: '#d4af37', fontWeight: '500' },
