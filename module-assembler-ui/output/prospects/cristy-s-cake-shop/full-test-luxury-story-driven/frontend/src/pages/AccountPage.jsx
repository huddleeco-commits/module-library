...
const styles = {
  ...
  avatar: { width: '80px', height: '80px', borderRadius: '50%', background: '#d4af37', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '32px', fontWeight: '700', margin: '0 auto 16px' },
  name: { fontSize: '24px', fontWeight: '700', color: '#f5f5f0', marginBottom: '4px' },
  email: { fontSize: '14px', color: '#f5f5f0', opacity: 0.7 },
  menuList: { display: 'flex', flexDirection: 'column', gap: '12px' },
  menuItem: { display: 'flex', alignItems: 'center', gap: '16px', padding: '20px', background: '#1a1a1f', borderRadius: '16px', textDecoration: 'none', boxShadow: '0 4px 20px rgba(0,0,0,0.3)' },
  menuInfo: { flex: 1, display: 'flex', flexDirection: 'column' },
  menuLabel: { fontWeight: '600', color: '#f5f5f0', marginBottom: '2px' },
  menuDesc: { fontSize: '13px', color: '#f5f5f0', opacity: 0.6 }
};
