...
const styles = {
  ...
  title: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: 'clamp(2.5rem, 5vw, 3.5rem)', fontWeight: '300', marginTop: '16px', marginBottom: '12px' },
  ...
  infoText: { color: '#94a3b8', lineHeight: 1.6 },
  form: { background: '#1e293b', padding: '40px', borderRadius: '4px' },
  formTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.5rem', fontWeight: '300', marginBottom: '32px' },
  input: { width: '100%', padding: '16px', border: 'none', borderBottom: '1px solid #334155', fontSize: '1rem', marginBottom: '20px', background: 'transparent', color: '#f8fafc' },
  textarea: { width: '100%', padding: '16px', border: 'none', borderBottom: '1px solid #334155', fontSize: '1rem', marginBottom: '20px', resize: 'vertical', background: 'transparent', color: '#f8fafc' },
  submitBtn: { width: '100%', background: '#DEB887', color: '#0f172a', border: 'none', padding: '16px', fontSize: '0.9rem', letterSpacing: '2px', cursor: 'pointer' }
};
