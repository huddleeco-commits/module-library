...
const styles = {
  ...
  heroTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: '300', marginTop: '16px', marginBottom: '12px' },
  heroSubtitle: { color: '#94a3b8', fontSize: '1.1rem' },
  statement: { padding: '60px 24px', textAlign: 'center', background: '#1e293b' },
  statementText: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: 'clamp(1.25rem, 2.5vw, 1.5rem)', fontWeight: '300', maxWidth: '800px', margin: '0 auto', lineHeight: 1.8 },
  ...
  philItem: {},
  philLabel: { color: '#DEB887', letterSpacing: '3px', fontSize: '0.75rem' },
  philTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.5rem', fontWeight: '400', margin: '16px 0' },
  philText: { color: '#94a3b8', lineHeight: 1.8 }
};
