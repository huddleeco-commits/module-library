...
const styles = {
  page: { background: '#0f172a', color: '#f8fafc' },
  ...
  slideTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: '300', marginBottom: '16px', lineHeight: 1.1, color: '#fff' },
  ...
  statement: { padding: '100px 24px', textAlign: 'center', background: '#1e293b' },
  statementText: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: '300', maxWidth: '800px', margin: '0 auto', lineHeight: 1.6, color: '#f8fafc' },
  ...
  productCard: { textDecoration: 'none', color: '#f8fafc' },
  ...
  productName: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.25rem', fontWeight: '400', marginBottom: '8px' },
  productPrice: { color: '#DEB887', letterSpacing: '1px' },
  cta: { padding: '120px 24px', textAlign: 'center', background: '#1e293b' },
  ctaTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '2.5rem', fontWeight: '300', marginBottom: '16px' },
  ctaText: { color: '#94a3b8', marginBottom: '32px' },
  ctaBtns: { display: 'flex', gap: '16px', justifyContent: 'center' },
  ctaBtn: { background: '#DEB887', color: '#0f172a', padding: '16px 40px', textDecoration: 'none', letterSpacing: '2px', fontSize: '0.85rem' },
  ctaBtnOutline: { background: 'transparent', color: '#f8fafc', padding: '16px 40px', textDecoration: 'none', letterSpacing: '2px', fontSize: '0.85rem', border: '1px solid #f8fafc' }
};
