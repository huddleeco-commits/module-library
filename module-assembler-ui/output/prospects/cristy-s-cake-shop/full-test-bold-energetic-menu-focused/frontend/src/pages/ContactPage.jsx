...
const styles = {
  ...
  optionCard: { background: '#ffffff', padding: '24px', borderRadius: '8px', textDecoration: 'none', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', transition: 'transform 0.2s', display: 'block' },
  optionTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontWeight: '600', color: '#1f2937', margin: '12px 0 4px' },
  optionDesc: { color: '#4b5563', fontSize: '0.9rem', marginBottom: '12px' },
  optionLink: { display: 'flex', alignItems: 'center', gap: '4px', color: '#8B4513', fontSize: '0.9rem', fontWeight: '500' },
  formSection: { padding: '60px 20px', background: '#e5e5e5' },
  formGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '48px', alignItems: 'start' },
  formInfo: {},
  formTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.75rem', fontWeight: '700', color: '#1f2937', marginBottom: '16px' },
  formText: { color: '#4b5563', lineHeight: 1.6, marginBottom: '24px' },
  ...
  form: { background: '#ffffff', padding: '28px', borderRadius: '8px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' },
  formRow: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' },
  input: { width: '100%', padding: '12px 14px', border: '1px solid #d1d5db', borderRadius: '8px', fontSize: '1rem', marginBottom: '12px', background: '#f0f0f0', color: '#1f2937' },
  textarea: { width: '100%', padding: '12px 14px', border: '1px solid #d1d5db', borderRadius: '8px', fontSize: '1rem', marginBottom: '12px', resize: 'vertical', background: '#f0f0f0', color: '#1f2937' },
