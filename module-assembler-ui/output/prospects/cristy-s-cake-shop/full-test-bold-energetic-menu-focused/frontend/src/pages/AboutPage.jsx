...
const styles = {
  ...
  hero: { padding: '80px 24px', textAlign: 'center', background: '#e5e5e5' },
  ...
  heroTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: '700', color: '#1f2937', marginBottom: '16px' },
  heroSubtitle: { color: '#4b5563', fontSize: '1.1rem', lineHeight: 1.6 },
  ...
  missionContent: {},
  sectionTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#1f2937', marginBottom: '20px' },
  missionText: { color: '#4b5563', lineHeight: 1.8, marginBottom: '16px' },
  cta: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#8B4513', color: '#fff', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', marginTop: '8px' },
  features: { padding: '60px 20px', background: '#e5e5e5' },
  featuresGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '24px' },
  featureCard: { background: '#ffffff', padding: '28px', borderRadius: '8px', textAlign: 'center' },
  featureTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.1rem', fontWeight: '600', color: '#1f2937', margin: '12px 0 8px' },
  featureDesc: { color: '#4b5563', fontSize: '0.95rem' }
};
