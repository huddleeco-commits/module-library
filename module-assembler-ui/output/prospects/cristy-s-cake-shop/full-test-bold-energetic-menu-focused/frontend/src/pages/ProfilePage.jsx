...
const styles = {
  ...
  title: { fontSize: '28px', fontWeight: '700', color: '#1f2937', marginBottom: '8px' },
  subtitle: { fontSize: '14px', color: '#1f2937', opacity: 0.7 },
  card: { background: '#e5e5e5', borderRadius: '8px', padding: '32px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)' },
  ...
  label: { display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', fontWeight: '500', color: '#1f2937' },
