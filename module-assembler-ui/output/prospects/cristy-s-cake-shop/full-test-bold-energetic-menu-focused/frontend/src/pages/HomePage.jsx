...
const styles = {
  ...
  hero: { padding: '60px 20px', background: '#e5e5e5' },
  ...
  heroContent: {},
  heroTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: '700', color: '#1f2937', marginBottom: '16px', lineHeight: 1.2 },
  heroSubtitle: { color: '#4b5563', fontSize: '1.1rem', marginBottom: '24px', lineHeight: 1.6 },
  ...
  trustStrip: { display: 'flex', justifyContent: 'center', gap: '32px', padding: '20px', background: '#f0f0f0', borderBottom: '1px solid #d1d5db', flexWrap: 'wrap' },
  trustItem: { display: 'flex', alignItems: 'center', gap: '8px', color: '#4b5563', fontSize: '14px' },
  ...
  sectionTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.75rem', fontWeight: '700', color: '#1f2937' },
  ...
  productCard: { background: '#ffffff', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  ...
  productName: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontWeight: '600', padding: '16px 16px 4px', color: '#1f2937' },
  ...
  categories: { padding: '60px 20px', background: '#e5e5e5' },
