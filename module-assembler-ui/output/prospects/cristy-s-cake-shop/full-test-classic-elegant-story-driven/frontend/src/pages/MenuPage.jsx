...
const styles = {
  ...
  collectionName: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.5rem', fontWeight: '400', marginBottom: '32px', paddingBottom: '16px', borderBottom: '1px solid #DEB887' },
  items: {},
  ...
  itemName: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.1rem', fontWeight: '400' },
  itemPrice: { color: '#DEB887' },
  itemDesc: { color: '#94a3b8', fontSize: '0.95rem' }
};
