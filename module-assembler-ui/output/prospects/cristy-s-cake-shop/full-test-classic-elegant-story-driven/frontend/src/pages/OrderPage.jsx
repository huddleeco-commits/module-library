...
const styles = {
  ...
  serviceCard: { background: '#1e293b', padding: '32px', cursor: 'pointer', transition: 'all 0.3s', border: '1px solid transparent' },
  serviceActive: { borderColor: '#DEB887' },
  serviceTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.25rem', fontWeight: '400', marginBottom: '12px' },
  serviceDesc: { color: '#94a3b8', lineHeight: 1.6, marginBottom: '16px' },
  serviceTime: { display: 'flex', alignItems: 'center', gap: '8px', color: '#DEB887', fontSize: '0.9rem' },
  action: { padding: '80px 24px', textAlign: 'center', background: '#1e293b' },
  actionContent: { maxWidth: '500px', margin: '0 auto' },
  actionTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '2rem', fontWeight: '300', marginBottom: '16px' },
  actionText: { color: '#94a3b8', lineHeight: 1.6, marginBottom: '32px' },
  ...
  noteText: { color: '#94a3b8', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6, fontStyle: 'italic' }
};
