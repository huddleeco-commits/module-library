...
const styles = {
  ...
  hero: { padding: '120px 20px', background: '#FFF8F5' },
  ...
  primaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#8B4513', color: '#fff', padding: '14px 28px', borderRadius: '8px', fontWeight: '600', textDecoration: 'none', fontSize: '1rem' },
  secondaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'transparent', color: '#8B4513', padding: '14px 28px', borderRadius: '8px', fontWeight: '600', textDecoration: 'none', border: '2px solid #8B4513' },
  ...
  categories: { padding: '120px 20px', background: '#FFF8F5' },
