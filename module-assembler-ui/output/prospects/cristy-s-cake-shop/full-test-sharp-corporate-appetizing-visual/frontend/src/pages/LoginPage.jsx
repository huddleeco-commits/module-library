...
const styles = {
  page: { minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 20px', background: '#FFF8F0' },
  card: { width: '100%', maxWidth: '420px', background: '#f8fafc', borderRadius: '8px', padding: '40px', boxShadow: '0 4px 12px rgba(0,0,0,0.08)' },
  header: { textAlign: 'center', marginBottom: '32px' },
  title: { fontSize: '24px', fontWeight: '700', color: '#3E2723', marginTop: '16px', marginBottom: '8px' },
  ...
  label: { fontSize: '14px', fontWeight: '500', color: '#3E2723' },
  ...
  submitBtn: { padding: '14px', background: '#b8860b', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '16px', fontWeight: '600', cursor: 'pointer' },
  footerText: { textAlign: 'center', marginTop: '24px', fontSize: '14px', color: '#3E2723', opacity: 0.7 },
