          ...
          <div style={styles.valuesGrid}>
            {values.map((value, i) => (
              <div key={i} style={styles.valueCard}>
                <value.icon size={32} color="#b8860b" />
...
const styles = {
  ...
  milestoneYear: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontWeight: '700', color: '#b8860b', textAlign: 'right' },
  milestoneDot: { width: '12px', height: '12px', borderRadius: '50%', background: '#b8860b' },
