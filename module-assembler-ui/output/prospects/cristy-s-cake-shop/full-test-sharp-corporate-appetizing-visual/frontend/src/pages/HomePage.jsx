            ...
            {reviews.map((review, i) => (
              <div key={i} style={styles.reviewCard}>
                <div style={styles.stars}>
                  {[...Array(review.stars)].map((_, j) => <Star key={j} size={16} fill="#b8860b" color="#b8860b" />)}
                </div>
...
const styles = {
  ...
  primaryBtn: { background: '#b8860b', color: '#fff', padding: '16px 32px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', fontSize: '1rem' },
  ...
  specialPrice: { color: '#b8860b', fontWeight: '700', fontSize: '1.2rem' },
  centerCta: { textAlign: 'center', marginTop: '40px' },
  outlineBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#b8860b', border: '2px solid #b8860b', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600' },
  ...
  storyLink: { display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#b8860b', textDecoration: 'none', fontWeight: '600', marginTop: '8px' },
  ...
  contactBar: { background: '#b8860b', padding: '32px 24px' },
  ...
  contactBtn: { display: 'flex', alignItems: 'center', gap: '12px', background: '#fff', color: '#b8860b', padding: '16px 32px', borderRadius: '8px', textDecoration: 'none', fontWeight: '700', fontSize: '1.1rem' }
};
