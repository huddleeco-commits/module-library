...
const styles = {
  ...
  optionActive: { borderColor: '#b8860b', background: '#b8860b', color: '#fff' },
  ...
  menuPrice: { color: '#b8860b', fontWeight: '700' },
  addBtn: { width: '40px', height: '40px', borderRadius: '50%', border: 'none', background: '#b8860b', color: '#fff', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  cartPrice: { color: '#b8860b', fontWeight: '600' },
  ...
  totalAmount: { color: '#b8860b' },
  checkoutBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', width: '100%', background: '#b8860b', color: '#fff', border: 'none', padding: '16px', borderRadius: '8px', fontSize: '1rem', fontWeight: '600', cursor: 'pointer' },
  ...
  callBtn: { display: 'inline-flex', alignItems: 'center', gap: '6px', color: '#b8860b', textDecoration: 'none', fontWeight: '600' }
};
