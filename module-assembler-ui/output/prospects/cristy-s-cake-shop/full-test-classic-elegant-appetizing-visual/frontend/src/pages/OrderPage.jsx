...
const styles = {
  ...
  header: { padding: '48px 24px', textAlign: 'center', background: '#1e293b' },
  title: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#f8fafc', marginBottom: '8px' },
  subtitle: { color: '#94a3b8' },
  orderOptions: { padding: '24px', textAlign: 'center', borderBottom: '1px solid #334155' },
  optionBtns: { display: 'flex', gap: '12px', justifyContent: 'center', marginBottom: '12px' },
  optionBtn: { display: 'flex', alignItems: 'center', gap: '8px', padding: '12px 24px', border: '2px solid #334155', borderRadius: '16px', background: '#1e293b', cursor: 'pointer', fontWeight: '500', color: '#f8fafc' },
  ...
  menu: {},
  sectionTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.5rem', fontWeight: '600', color: '#f8fafc', marginBottom: '24px' },
  menuGrid: { display: 'flex', flexDirection: 'column', gap: '12px' },
  menuCard: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#1e293b', padding: '16px', borderRadius: '16px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  menuInfo: {},
  menuName: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontWeight: '600', color: '#f8fafc', marginBottom: '2px' },
  menuCategory: { color: '#94a3b8', fontSize: '0.85rem', marginBottom: '4px' },
  ...
  cartSection: { background: '#1e293b', padding: '24px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)', height: 'fit-content', position: 'sticky', top: '24px' },
  emptyCart: { color: '#94a3b8', textAlign: 'center', padding: '32px 0' },
  cartItem: { padding: '12px 0', borderBottom: '1px solid #334155' },
  cartInfo: { display: 'flex', justifyContent: 'space-between', marginBottom: '8px' },
  cartName: { fontWeight: '500', color: '#f8fafc' },
  cartPrice: { color: '#8B4513', fontWeight: '600' },
  cartControls: { display: 'flex', alignItems: 'center', gap: '12px' },
  qtyBtn: { width: '28px', height: '28px', borderRadius: '50%', border: '1px solid #334155', background: '#0f172a', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#f8fafc' },
  qty: { fontWeight: '600', color: '#f8fafc' },
  cartTotal: { display: 'flex', justifyContent: 'space-between', padding: '16px 0', fontWeight: '600', fontSize: '1.1rem', color: '#f8fafc' },
  totalAmount: { color: '#8B4513' },
  checkoutBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', width: '100%', background: '#8B4513', color: '#fff', border: 'none', padding: '16px', borderRadius: '16px', fontSize: '1rem', fontWeight: '600', cursor: 'pointer' },
  callOption: { marginTop: '24px', textAlign: 'center', paddingTop: '24px', borderTop: '1px solid #334155' },
  callText: { color: '#94a3b8', marginBottom: '8px', fontSize: '0.9rem' },
