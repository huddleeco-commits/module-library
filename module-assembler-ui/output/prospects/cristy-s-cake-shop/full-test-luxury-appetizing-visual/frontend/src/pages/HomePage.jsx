      ...
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <div style={styles.heroCtas}>
            ...
            <a href="tel:(214) 513-2253" style={styles.secondaryBtn}><Phone size={18} /> Call Us</a>
          </div>
          <div style={styles.heroInfo}>
            <span><MapPin size={16} /> 3721 Justin Rd #150, Flower Mound, TX 75028, USA</span>
      ...
      <section style={styles.contactBar}>
        <div style={styles.contactContent}>
          <div>
            ...
            <p style={styles.contactText}>3721 Justin Rd #150, Flower Mound, TX 75028, USA</p>
          </div>
          <a href="tel:(214) 513-2253" style={styles.contactBtn}><Phone size={20} /> (214) 513-2253</a>
        </div>
      </section>
    </div>
  );
...
const styles = {
  ...
  heroTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: 'clamp(2.5rem, 6vw, 4rem)', fontWeight: '700', marginBottom: '16px', textShadow: '0 2px 20px rgba(0,0,0,0.3)' },
  ...
  primaryBtn: { background: '#8B4513', color: '#fff', padding: '16px 32px', borderRadius: '16px', textDecoration: 'none', fontWeight: '600', fontSize: '1rem' },
  secondaryBtn: { display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.2)', backdropFilter: 'blur(10px)', color: '#fff', padding: '16px 32px', borderRadius: '16px', textDecoration: 'none', fontWeight: '600' },
  heroInfo: { display: 'flex', gap: '24px', justifyContent: 'center', flexWrap: 'wrap', fontSize: '0.95rem', opacity: 0.9 },
  specials: { padding: '120px 20px' },
  container: { maxWidth: '1100px', margin: '0 auto', padding: '0 24px' },
  sectionHeader: { textAlign: 'center', marginBottom: '48px' },
  sectionTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#f8fafc', marginBottom: '12px' },
  sectionTitleCenter: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#f8fafc', textAlign: 'center', marginBottom: '48px' },
  sectionSubtitle: { color: '#94a3b8', fontSize: '1.1rem' },
  specialsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '28px' },
  specialCard: { background: '#1e293b', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' },
  specialImage: { width: '100%', height: '200px', objectFit: 'cover' },
  specialInfo: { padding: '20px' },
  specialName: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.25rem', fontWeight: '600', color: '#f8fafc', marginBottom: '8px' },
  specialDesc: { color: '#94a3b8', marginBottom: '12px', lineHeight: 1.5 },
  specialPrice: { color: '#8B4513', fontWeight: '700', fontSize: '1.2rem' },
  centerCta: { textAlign: 'center', marginTop: '40px' },
  outlineBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#8B4513', border: '2px solid #8B4513', padding: '14px 28px', borderRadius: '16px', textDecoration: 'none', fontWeight: '600' },
  story: { padding: '120px 20px', background: '#1e293b' },
  ...
  storyImage: { width: '100%', borderRadius: '16px', boxShadow: '0 10px 40px rgba(0,0,0,0.15)' },
  storyContent: {},
  storyTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#f8fafc', marginBottom: '20px' },
  storyText: { color: '#94a3b8', lineHeight: 1.8, marginBottom: '16px', fontSize: '1.05rem' },
  storyLink: { display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#8B4513', textDecoration: 'none', fontWeight: '600', marginTop: '8px' },
  reviews: { padding: '120px 20px' },
  reviewsGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' },
  reviewCard: { background: '#1e293b', padding: '28px', borderRadius: '16px', boxShadow: '0 2px 12px rgba(0,0,0,0.06)' },
  stars: { display: 'flex', gap: '4px', marginBottom: '16px' },
  reviewText: { color: '#f8fafc', lineHeight: 1.7, marginBottom: '16px', fontStyle: 'italic' },
  reviewAuthor: { color: '#94a3b8', fontWeight: '500' },
  ...
  contactBtn: { display: 'flex', alignItems: 'center', gap: '12px', background: '#fff', color: '#8B4513', padding: '16px 32px', borderRadius: '16px', textDecoration: 'none', fontWeight: '700', fontSize: '1.1rem' }
};
