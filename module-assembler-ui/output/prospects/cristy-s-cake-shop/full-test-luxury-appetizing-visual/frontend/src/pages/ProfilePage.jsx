...
const styles = {
  ...
  title: { fontSize: '28px', fontWeight: '700', color: '#f5f5f0', marginBottom: '8px' },
  subtitle: { fontSize: '14px', color: '#f5f5f0', opacity: 0.7 },
  card: { background: '#1a1a1f', borderRadius: '16px', padding: '32px', boxShadow: '0 4px 20px rgba(0,0,0,0.3)' },
  avatarSection: { display: 'flex', justifyContent: 'center', marginBottom: '32px' },
  avatar: { width: '100px', height: '100px', borderRadius: '50%', background: '#d4af37', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '40px', fontWeight: '700' },
  form: { display: 'flex', flexDirection: 'column', gap: '20px' },
  message: { padding: '12px', borderRadius: '8px', fontSize: '14px', textAlign: 'center', background: '#dcfce7', color: '#16a34a' },
  inputGroup: { display: 'flex', flexDirection: 'column', gap: '6px' },
  label: { display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', fontWeight: '500', color: '#f5f5f0' },
  input: { padding: '14px', border: '1px solid #e5e7eb', borderRadius: '16px', fontSize: '16px', outline: 'none' },
  actions: { display: 'flex', gap: '16px', marginTop: '16px' },
  saveBtn: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '14px', background: '#d4af37', color: '#fff', border: 'none', borderRadius: '16px', fontSize: '16px', fontWeight: '600', cursor: 'pointer' },
  logoutBtn: { display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '14px 24px', background: 'transparent', color: '#dc2626', border: '1px solid #dc2626', borderRadius: '16px', fontSize: '16px', fontWeight: '500', cursor: 'pointer' }
};
