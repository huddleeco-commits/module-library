          ...
          <div style={styles.storyGrid}>
            ...
            <div style={styles.storyContent}>
              ...
              <p style={styles.storyText}>
                Cristy's Cake Shop began with a simple dream: to share our family recipes with the community.
...
const styles = {
  ...
  heroTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: 'clamp(2.5rem, 5vw, 4rem)', fontWeight: '700', marginBottom: '12px' },
  heroSubtitle: { fontSize: '1.25rem', opacity: 0.9 },
  story: { padding: '120px 20px' },
  ...
  storyImage: {},
  storyImg: { width: '100%', borderRadius: '16px', boxShadow: '0 10px 40px rgba(0,0,0,0.15)' },
  storyContent: {},
  ...
  values: { padding: '120px 20px', background: '#1e293b' },
  valuesGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '32px' },
  valueCard: { background: '#1e293b', padding: '32px', borderRadius: '16px', textAlign: 'center', boxShadow: '0 4px 20px rgba(0,0,0,0.06)' },
  valueTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.25rem', fontWeight: '600', color: '#f8fafc', margin: '16px 0 8px' },
  valueDesc: { color: '#94a3b8', lineHeight: 1.6 },
  timeline: { padding: '120px 20px' },
  ...
  milestoneYear: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontWeight: '700', color: '#8B4513', textAlign: 'right' },
  milestoneDot: { width: '12px', height: '12px', borderRadius: '50%', background: '#8B4513' },
  milestoneEvent: { color: '#f8fafc' }
};
