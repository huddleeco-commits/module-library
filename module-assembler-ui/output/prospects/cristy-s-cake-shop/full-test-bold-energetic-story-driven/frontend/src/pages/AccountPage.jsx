...
const styles = {
  ...
  name: { fontSize: '24px', fontWeight: '700', color: '#1f2937', marginBottom: '4px' },
  email: { fontSize: '14px', color: '#1f2937', opacity: 0.7 },
  menuList: { display: 'flex', flexDirection: 'column', gap: '12px' },
  menuItem: { display: 'flex', alignItems: 'center', gap: '16px', padding: '20px', background: '#e5e5e5', borderRadius: '8px', textDecoration: 'none', boxShadow: '0 4px 12px rgba(0,0,0,0.08)' },
  menuInfo: { flex: 1, display: 'flex', flexDirection: 'column' },
  menuLabel: { fontWeight: '600', color: '#1f2937', marginBottom: '2px' },
  menuDesc: { fontSize: '13px', color: '#1f2937', opacity: 0.6 }
};
