...
const styles = {
  ...
  serviceCard: { background: '#e5e5e5', padding: '32px', cursor: 'pointer', transition: 'all 0.3s', border: '1px solid transparent' },
  ...
  serviceDesc: { color: '#4b5563', lineHeight: 1.6, marginBottom: '16px' },
  serviceTime: { display: 'flex', alignItems: 'center', gap: '8px', color: '#DEB887', fontSize: '0.9rem' },
  action: { padding: '80px 24px', textAlign: 'center', background: '#e5e5e5' },
  ...
  actionText: { color: '#4b5563', lineHeight: 1.6, marginBottom: '32px' },
  ...
  noteText: { color: '#4b5563', maxWidth: '600px', margin: '0 auto', lineHeight: 1.6, fontStyle: 'italic' }
};
