...
const styles = {
  ...
  optionLink: { display: 'flex', alignItems: 'center', gap: '4px', color: '#b8860b', fontSize: '0.9rem', fontWeight: '500' },
  formSection: { padding: '80px 20px', background: '#FFF8F5' },
  ...
  quickLink: { display: 'flex', alignItems: 'center', gap: '8px', color: '#b8860b', textDecoration: 'none', fontWeight: '500' },
  ...
  submitBtn: { width: '100%', background: '#b8860b', color: '#fff', border: 'none', padding: '14px', borderRadius: '8px', fontSize: '1rem', fontWeight: '600', cursor: 'pointer' }
};
