          ...
          <div style={styles.featuresGrid}>
            {features.map((feature, i) => (
              <div key={i} style={styles.featureCard}>
                <feature.icon size={28} color="#b8860b" />
...
const styles = {
  ...
  hero: { padding: '80px 24px', textAlign: 'center', background: '#FFF8F5' },
  heroContent: { maxWidth: '700px', margin: '0 auto' },
  badge: { display: 'inline-block', background: '#b8860b', color: '#fff', padding: '8px 20px', borderRadius: '20px', fontSize: '0.9rem', marginBottom: '20px' },
  heroTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: '700', color: '#3E2723', marginBottom: '16px' },
  heroSubtitle: { color: '#64748b', fontSize: '1.1rem', lineHeight: 1.6 },
  stats: { padding: '48px 24px', background: '#b8860b' },
  ...
  missionImage: { width: '100%', borderRadius: '8px', boxShadow: '0 10px 40px rgba(0,0,0,0.1)' },
  missionContent: {},
  sectionTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#3E2723', marginBottom: '20px' },
  missionText: { color: '#64748b', lineHeight: 1.8, marginBottom: '16px' },
  cta: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#b8860b', color: '#fff', padding: '14px 28px', borderRadius: '8px', textDecoration: 'none', fontWeight: '600', marginTop: '8px' },
  features: { padding: '80px 20px', background: '#FFF8F5' },
  featuresGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '24px' },
  featureCard: { background: '#fff', padding: '28px', borderRadius: '8px', textAlign: 'center' },
  featureTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.1rem', fontWeight: '600', color: '#3E2723', margin: '12px 0 8px' },
  featureDesc: { color: '#64748b', fontSize: '0.95rem' }
};
