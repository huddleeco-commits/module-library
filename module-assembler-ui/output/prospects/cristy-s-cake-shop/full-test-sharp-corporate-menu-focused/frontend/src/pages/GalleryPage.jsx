...
const styles = {
  ...
  filters: { padding: '24px', borderBottom: '1px solid #e5e7eb' },
  filterBtns: { display: 'flex', gap: '8px', justifyContent: 'center', flexWrap: 'wrap' },
  filterBtn: { padding: '10px 20px', border: '1px solid #e5e7eb', borderRadius: '20px', background: '#fff', cursor: 'pointer', fontSize: '0.9rem', color: '#3E2723' },
  filterActive: { background: '#b8860b', color: '#fff', borderColor: '#b8860b' },
  gallery: { padding: '80px 20px' },
  container: { maxWidth: '1200px', margin: '0 auto', padding: '0 24px' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '24px' },
  card: { background: '#fff', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  ...
  cardTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontWeight: '600', color: '#3E2723', marginBottom: '4px' },
  cardPrice: { color: '#b8860b', fontWeight: '700', marginBottom: '12px' },
  shopBtn: { display: 'inline-flex', alignItems: 'center', gap: '6px', background: '#b8860b', color: '#fff', padding: '10px 20px', borderRadius: '8px', textDecoration: 'none', fontSize: '0.9rem', fontWeight: '600' },
