...
const styles = {
  announcementBar: { background: '#b8860b', color: '#fff', padding: '10px 20px', textAlign: 'center', fontSize: '14px' },
  ...
  primaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#b8860b', color: '#fff', padding: '16px 32px', borderRadius: '8px', fontWeight: '600', textDecoration: 'none', fontSize: '1rem' },
  secondaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'transparent', color: '#b8860b', padding: '16px 32px', borderRadius: '8px', fontWeight: '600', textDecoration: 'none', border: '2px solid #b8860b' },
  ...
  viewAllLink: { display: 'flex', alignItems: 'center', gap: '4px', color: '#b8860b', textDecoration: 'none', fontWeight: '600' },
  ...
  productBadge: { position: 'absolute', top: '12px', left: '12px', background: '#b8860b', color: '#fff', padding: '4px 12px', borderRadius: '20px', fontSize: '12px', fontWeight: '600' },
  productName: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontWeight: '600', padding: '16px 16px 4px', color: '#3E2723' },
  productPrice: { padding: '0 16px', color: '#b8860b', fontWeight: '700', fontSize: '1.1rem' },
  addToCartBtn: { margin: '16px', width: 'calc(100% - 32px)', background: '#b8860b', color: '#fff', border: 'none', padding: '12px', borderRadius: '8px', fontWeight: '600', cursor: 'pointer' },
