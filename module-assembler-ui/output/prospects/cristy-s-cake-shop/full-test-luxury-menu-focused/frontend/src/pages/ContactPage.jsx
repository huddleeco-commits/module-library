...
const styles = {
  ...
  optionCard: { background: '#1e293b', padding: '24px', borderRadius: '16px', textDecoration: 'none', boxShadow: '0 2px 8px rgba(0,0,0,0.06)', transition: 'transform 0.2s', display: 'block' },
  optionTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontWeight: '600', color: '#f8fafc', margin: '12px 0 4px' },
  optionDesc: { color: '#94a3b8', fontSize: '0.9rem', marginBottom: '12px' },
  optionLink: { display: 'flex', alignItems: 'center', gap: '4px', color: '#8B4513', fontSize: '0.9rem', fontWeight: '500' },
  formSection: { padding: '120px 20px', background: '#1e293b' },
  formGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '48px', alignItems: 'start' },
  formInfo: {},
  formTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.75rem', fontWeight: '700', color: '#f8fafc', marginBottom: '16px' },
  formText: { color: '#94a3b8', lineHeight: 1.6, marginBottom: '24px' },
  ...
  form: { background: '#1e293b', padding: '28px', borderRadius: '16px', boxShadow: '0 4px 20px rgba(0,0,0,0.08)' },
  formRow: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' },
  input: { width: '100%', padding: '12px 14px', border: '1px solid #334155', borderRadius: '8px', fontSize: '1rem', marginBottom: '12px', background: '#0f172a', color: '#f8fafc' },
  textarea: { width: '100%', padding: '12px 14px', border: '1px solid #334155', borderRadius: '8px', fontSize: '1rem', marginBottom: '12px', resize: 'vertical', background: '#0f172a', color: '#f8fafc' },
