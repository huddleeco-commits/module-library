...
const styles = {
  ...
  title: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '2rem', fontWeight: '700', color: '#f8fafc' },
  ...
  productCard: { background: '#fff', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  productImage: { width: '100%', height: '180px', objectFit: 'cover' },
  productInfo: { padding: '16px' },
  productName: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1rem', fontWeight: '600', color: '#f8fafc', marginBottom: '4px' },
