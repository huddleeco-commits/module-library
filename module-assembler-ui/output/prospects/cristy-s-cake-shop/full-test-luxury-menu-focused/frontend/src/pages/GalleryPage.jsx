...
const styles = {
  ...
  filters: { padding: '24px', borderBottom: '1px solid #334155' },
  filterBtns: { display: 'flex', gap: '8px', justifyContent: 'center', flexWrap: 'wrap' },
  filterBtn: { padding: '10px 20px', border: '1px solid #334155', borderRadius: '20px', background: '#1e293b', cursor: 'pointer', fontSize: '0.9rem', color: '#f8fafc' },
  filterActive: { background: '#8B4513', color: '#fff', borderColor: '#8B4513' },
  gallery: { padding: '120px 20px' },
  container: { maxWidth: '1200px', margin: '0 auto', padding: '0 24px' },
  grid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '24px' },
  card: { background: '#1e293b', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  ...
  cardTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontWeight: '600', color: '#f8fafc', marginBottom: '4px' },
