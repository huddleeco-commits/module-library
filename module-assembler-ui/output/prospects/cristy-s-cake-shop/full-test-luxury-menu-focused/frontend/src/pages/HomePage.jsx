...
const styles = {
  ...
  hero: { padding: '120px 20px', background: '#1e293b' },
  ...
  heroMainImage: { width: '100%', borderRadius: '16px', objectFit: 'cover', maxHeight: '400px' },
  heroContent: {},
  heroTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: '700', color: '#f8fafc', marginBottom: '16px', lineHeight: 1.2 },
  heroSubtitle: { color: '#94a3b8', fontSize: '1.1rem', marginBottom: '24px', lineHeight: 1.6 },
  heroCtas: { display: 'flex', gap: '12px', flexWrap: 'wrap' },
  primaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#8B4513', color: '#fff', padding: '14px 28px', borderRadius: '16px', fontWeight: '600', textDecoration: 'none', fontSize: '1rem' },
  secondaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'transparent', color: '#8B4513', padding: '14px 28px', borderRadius: '16px', fontWeight: '600', textDecoration: 'none', border: '2px solid #8B4513' },
  trustStrip: { display: 'flex', justifyContent: 'center', gap: '32px', padding: '20px', background: '#0f172a', borderBottom: '1px solid #334155', flexWrap: 'wrap' },
  trustItem: { display: 'flex', alignItems: 'center', gap: '8px', color: '#94a3b8', fontSize: '14px' },
  featured: { padding: '120px 20px' },
  container: { maxWidth: '1200px', margin: '0 auto', padding: '0 20px' },
  sectionHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' },
  sectionTitle: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.75rem', fontWeight: '700', color: '#f8fafc' },
  ...
  productCard: { background: '#1e293b', borderRadius: '16px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  ...
  productName: { fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontWeight: '600', padding: '16px 16px 4px', color: '#f8fafc' },
  productPrice: { padding: '0 16px', color: '#8B4513', fontWeight: '700', fontSize: '1.1rem' },
  addToCartBtn: { margin: '16px', width: 'calc(100% - 32px)', background: '#8B4513', color: '#fff', border: 'none', padding: '12px', borderRadius: '16px', fontWeight: '600', cursor: 'pointer' },
  categories: { padding: '120px 20px', background: '#1e293b' },
  categoryGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' },
  categoryCard: { position: 'relative', borderRadius: '16px', overflow: 'hidden', aspectRatio: '16/9', textDecoration: 'none' },
  ...
  categoryName: { color: '#fff', fontFamily: "'Inter', 'Outfit', system-ui, sans-serif", fontSize: '1.25rem', fontWeight: '600' }
};
