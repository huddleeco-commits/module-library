...
const styles = {
  ...
  itemTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.5rem', fontWeight: '300', color: '#fff', marginBottom: '4px' },
  itemSubtitle: { color: '#daa520', letterSpacing: '2px', fontSize: '0.8rem' },
  lightbox: { position: 'fixed', inset: 0, background: '#FFF8F0', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 },
  closeBtn: { position: 'absolute', top: '32px', right: '32px', background: 'none', border: 'none', color: '#3E2723', cursor: 'pointer' },
  navBtn: { position: 'absolute', left: '24px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: '1px solid #daa520', color: '#daa520', width: '56px', height: '56px', borderRadius: '50%', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  lightboxContent: { textAlign: 'center' },
  lightboxImage: { maxWidth: '70vw', maxHeight: '70vh', objectFit: 'contain' },
  lightboxInfo: { marginTop: '32px' },
  lightboxTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '2rem', fontWeight: '300', marginBottom: '8px' },
  lightboxSubtitle: { color: '#daa520', letterSpacing: '3px', fontSize: '0.85rem' }
};
