...
const styles = {
  page: { background: '#FFF8F0', color: '#3E2723' },
  ...
  slideLabel: { color: '#daa520', letterSpacing: '4px', fontSize: '0.85rem', marginBottom: '16px', display: 'block' },
  ...
  slideBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#daa520', textDecoration: 'none', fontSize: '0.9rem', letterSpacing: '2px', borderBottom: '1px solid #daa520', paddingBottom: '4px' },
  ...
  statement: { padding: '100px 24px', textAlign: 'center', background: '#F5F3F0' },
  statementText: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: 'clamp(1.5rem, 3vw, 2rem)', fontWeight: '300', maxWidth: '800px', margin: '0 auto', lineHeight: 1.6, color: '#3E2723' },
  products: { padding: '100px 24px' },
  container: { maxWidth: '1200px', margin: '0 auto' },
  sectionLabel: { textAlign: 'center', letterSpacing: '4px', fontSize: '0.85rem', color: '#daa520', marginBottom: '48px' },
  productGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '32px' },
  productCard: { textDecoration: 'none', color: '#3E2723' },
  ...
  productPrice: { color: '#daa520', letterSpacing: '1px' },
  cta: { padding: '120px 24px', textAlign: 'center', background: '#F5F3F0' },
  ctaTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '2.5rem', fontWeight: '300', marginBottom: '16px' },
  ctaText: { color: '#64748b', marginBottom: '32px' },
  ctaBtns: { display: 'flex', gap: '16px', justifyContent: 'center' },
  ctaBtn: { background: '#daa520', color: '#FFF8F0', padding: '16px 40px', textDecoration: 'none', letterSpacing: '2px', fontSize: '0.85rem' },
  ctaBtnOutline: { background: 'transparent', color: '#3E2723', padding: '16px 40px', textDecoration: 'none', letterSpacing: '2px', fontSize: '0.85rem', border: '1px solid #3E2723' }
};
