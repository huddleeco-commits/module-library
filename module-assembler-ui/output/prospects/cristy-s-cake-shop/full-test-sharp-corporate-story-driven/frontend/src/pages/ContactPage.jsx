...
const styles = {
  ...
  infoItem: {},
  infoLabel: { color: '#daa520', letterSpacing: '3px', fontSize: '0.75rem', display: 'block', marginBottom: '8px' },
  infoText: { color: '#64748b', lineHeight: 1.6 },
  form: { background: '#F5F3F0', padding: '40px', borderRadius: '4px' },
  formTitle: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.5rem', fontWeight: '300', marginBottom: '32px' },
  input: { width: '100%', padding: '16px', border: 'none', borderBottom: '1px solid rgba(255,255,255,0.2)', fontSize: '1rem', marginBottom: '20px', background: 'transparent', color: '#3E2723' },
  textarea: { width: '100%', padding: '16px', border: 'none', borderBottom: '1px solid rgba(255,255,255,0.2)', fontSize: '1rem', marginBottom: '20px', resize: 'vertical', background: 'transparent', color: '#3E2723' },
  submitBtn: { width: '100%', background: '#daa520', color: '#FFF8F0', border: 'none', padding: '16px', fontSize: '0.9rem', letterSpacing: '2px', cursor: 'pointer' }
};
