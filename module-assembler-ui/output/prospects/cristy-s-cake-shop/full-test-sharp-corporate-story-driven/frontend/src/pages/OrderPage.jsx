...
const styles = {
  ...
  serviceActive: { borderColor: '#daa520' },
  ...
  serviceTime: { display: 'flex', alignItems: 'center', gap: '8px', color: '#daa520', fontSize: '0.9rem' },
  ...
  actionBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#daa520', textDecoration: 'none', letterSpacing: '2px', fontSize: '0.9rem', borderBottom: '1px solid #daa520', paddingBottom: '4px' },
