...
const styles = {
  ...
  card: { background: '#0f172a', borderRadius: '16px', padding: '32px', boxShadow: '0 4px 20px rgba(0,0,0,0.3)' },
  avatarSection: { display: 'flex', justifyContent: 'center', marginBottom: '32px' },
  avatar: { width: '100px', height: '100px', borderRadius: '50%', background: '#b8860b', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '40px', fontWeight: '700' },
  form: { display: 'flex', flexDirection: 'column', gap: '20px' },
  message: { padding: '12px', borderRadius: '8px', fontSize: '14px', textAlign: 'center', background: '#dcfce7', color: '#16a34a' },
  inputGroup: { display: 'flex', flexDirection: 'column', gap: '6px' },
  label: { display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', fontWeight: '500', color: '#f1f5f9' },
  ...
  saveBtn: { flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '14px', background: '#b8860b', color: '#fff', border: 'none', borderRadius: '16px', fontSize: '16px', fontWeight: '600', cursor: 'pointer' },
