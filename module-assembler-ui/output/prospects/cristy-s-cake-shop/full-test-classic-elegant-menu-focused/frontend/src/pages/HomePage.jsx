...
const styles = {
  ...
  hero: { padding: '80px 20px', background: '#1e293b' },
  ...
  primaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: '#8B4513', color: '#fff', padding: '16px 32px', borderRadius: '16px', fontWeight: '600', textDecoration: 'none', fontSize: '1rem' },
  secondaryBtn: { display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'transparent', color: '#8B4513', padding: '16px 32px', borderRadius: '16px', fontWeight: '600', textDecoration: 'none', border: '2px solid #8B4513' },
  ...
  categories: { padding: '80px 20px', background: '#1e293b' },
