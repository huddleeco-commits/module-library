/**
 * Healthcare Patient Portal Page Template
 *
 * Sections:
 * 1. Hero - Portal access
 * 2. Features - What you can do
 * 3. Login/Register Form
 * 4. FAQ
 */

function generatePatientPortalPage(fixture, options = {}) {
              ...
              {isLogin ? (
                <form onSubmit={e => e.preventDefault()}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
                    ...
                    <a href="#" style={{ color: '${colors.primary}', fontSize: '14px' }}>Forgot password?</a>
                  </div>
...
module.exports = { generatePatientPortalPage };
