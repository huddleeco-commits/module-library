...
export default function HomePage() {
  const specials = [
    { name: 'Sourdough Boule', description: 'Classic San Francisco sourdough with tangy flavor and crispy crust, baked fresh daily.', price: '$8.50', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400' },
    { name: 'Everything Bagels (6-pack)', description: 'Hand-rolled bagels topped with sesame seeds, poppy seeds, garlic, onion, and sea salt.', price: '$12.00', image: 'https://images.unsplash.com/photo-1519869325930-281384f3a0d8?w=400' },
    ...
    <div style={{ background: '#FFF8F0' }}>
      ...
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.heroTitle}>Fresh Baked Daily in the Heart of SF</h1>
          <p style={styles.heroSubtitle}>Where traditional techniques meet innovative flavors, creating extraordinary pastries and breads that bring joy to every bite</p>
      ...
      <section style={styles.specials}>
        <div style={styles.container}>
          <div style={styles.sectionHeader}>
            ...
            <p style={styles.sectionSubtitle}>From buttery morning pastries to hearty artisan breads, we craft each item with care and attention to detail.</p>
          </div>
