    ...
    <footer style={styles.footer}>
      <div style={styles.container}>
        <div style={styles.brand}>
          <h3 style={styles.name}>AI Test Bakery</h3>
          <p style={styles.tagline}>Proudly serving our community</p>
        </div>
        <div style={styles.info}>
          <p style={styles.item}><MapPin size={16} /> 789 Tech Lane, San Francisco, CA 94102</p>
          <p style={styles.item}><Phone size={16} /> (415) 555-9876</p>
        </div>
        <div style={styles.copyright}>
          <p>&copy; 2026 AI Test Bakery. All rights reserved.</p>
