...
export default function HomePage() {
  const specials = [
    { name: 'Sourdough Boule', description: 'Traditional San Francisco sourdough with crispy crust and tangy, chewy interior', price: '$8.50', image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400' },
    { name: 'Whole Grain Seeded Loaf', description: 'Hearty multigrain bread topped with sunflower seeds, pumpkin seeds, and sesame', price: '$9.25', image: 'https://images.unsplash.com/photo-1519869325930-281384f3a0d8?w=400' },
    ...
    <div style={{ background: '#FFF8F0' }}>
      ...
      <section style={styles.hero}>
        ...
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.heroTitle}>Handcrafted Pastries Made with Love</h1>
          <p style={styles.heroSubtitle}>San Francisco\'s artisan bakery serving fresh-baked bread, flaky croissants, and decadent desserts daily</p>
          <div style={styles.heroCtas}>
            <Link to="/menu" style={styles.primaryBtn}>Order Fresh Today</Link>
      ...
      <section style={styles.specials}>
        <div style={styles.container}>
          <div style={styles.sectionHeader}>
            <h2 style={styles.sectionTitle}>Baked Fresh Every Morning</h2>
            <p style={styles.sectionSubtitle}>From morning pastries to celebration cakes, every item is made from scratch with care and attention to detail.</p>
          </div>
