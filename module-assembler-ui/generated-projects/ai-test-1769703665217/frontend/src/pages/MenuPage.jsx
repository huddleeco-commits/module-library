...
const styles = {
  ...
  subtitle: { color: '#6D4C41', fontSize: '1.1rem' },
  controls: { padding: '24px', maxWidth: '1100px', margin: '0 auto' },
  search: { position: 'relative', marginBottom: '20px' },
  searchIcon: { position: 'absolute', left: '16px', top: '50%', transform: 'translateY(-50%)', color: '#6D4C41' },
  searchInput: { width: '100%', padding: '14px 14px 14px 48px', border: '1px solid #e5e7eb', borderRadius: '8px', fontSize: '1rem' },
  ...
  card: { position: 'relative', background: '#fff', padding: '24px', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' },
  ...
  itemName: { fontFamily: "'DM Sans', 'Inter', system-ui, sans-serif", fontSize: '1.25rem', fontWeight: '600', color: '#3E2723', marginBottom: '8px' },
  itemDesc: { color: '#6D4C41', marginBottom: '12px', lineHeight: 1.5 },
