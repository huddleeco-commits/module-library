            ...
            {['Visit Type', 'Provider', 'Date & Time', 'Your Info'].map((label, idx) => (
              <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div style={{
                  ...
                  height: '36px',
                  borderRadius: '50%',
                  backgroundColor: step > idx + 1 ? '#059669' : step === idx + 1 ? '#0284C7' : 'rgba(0,0,0,0.1)',
                ...
                {VISIT_TYPES.map((type) => (
                  <button
                    ...
                    style={{
                      ...
                      padding: '24px',
                      backgroundColor: visitType?.id === type.id ? '#0284C710' : 'white',
                      border: visitType?.id === type.id ? '2px solid #0284C7' : '2px solid transparent',
                      borderRadius: '12px',
                      cursor: 'pointer',
                      textAlign: 'left',
          ...
          {step === 2 && (
            <div>
              <button onClick={() => setStep(1)} style={{
                ...
                border: 'none', cursor: 'pointer', marginBottom: '24px', color: '#0284C7'
              }}>
                ...
                {PROVIDERS.map((doc, idx) => (
                  <button
                    ...
                    style={{
                      ...
                      gap: '16px',
                      padding: '20px',
                      backgroundColor: provider?.name === doc.name ? '#0284C710' : 'white',
                      border: provider?.name === doc.name ? '2px solid #0284C7' : '2px solid transparent',
                      borderRadius: '12px',
                      cursor: 'pointer',
                      textAlign: 'left',
                      boxShadow: '0 2px 8px rgba(0,0,0,0.04)'
                  ...
                  >
                    <div style={{
                      ...
                      backgroundColor: '#0284C720', display: 'flex',
                      alignItems: 'center', justifyContent: 'center',
                      color: '#0284C7', fontWeight: '600', fontSize: '20px'
                    }}>
                      {doc.name.charAt(0)}
                    </div>
                    <div>
                ...
                <div style={{ display: 'flex', gap: '12px', overflowX: 'auto' }}>
                  {nextWeekDates.map((date, idx) => (
                    <button
                      ...
                      style={{
                        padding: '16px 24px',
                        backgroundColor: selectedDate?.toDateString() === date.toDateString() ? '#0284C7' : 'white',
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(120px, 1fr))', gap: '12px' }}>
                    {timeSlots.map((time, idx) => (
                      <button
                        ...
                        style={{
                          padding: '14px',
                          backgroundColor: selectedTime === time ? '#0284C7' : 'white',
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <p style={{ fontWeight: '600' }}>(555) 789-CARE</p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <p style={{ fontWeight: '600' }}>200 Health Plaza, Boston, MA 02108</p>
              </div>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
