/**
 * HomePage - Modern Wellness Layout
 * Business: Test FitZone
 * Industry: fitness
 * Generated: 2026-01-23T20:54:26.838Z
 *
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
            <div>
              <div style={{ fontSize: '32px', fontWeight: '700', color: '#00B4D8' }}>7+</div>
              <div style={{ fontSize: '14px', opacity: 0.7 }}>Years Experience</div>
            </div>
            <div>
              <div style={{ fontSize: '32px', fontWeight: '700', color: '#00B4D8' }}>1000+</div>
              <div style={{ fontSize: '14px', opacity: 0.7 }}>Happy Customers</div>
            </div>
            <div>
              <div style={{ fontSize: '32px', fontWeight: '700', color: '#00B4D8' }}>4.9</div>
        ...
        <div style={{
          ...
          <Building size={100} color="#00B4D8" style={{ opacity: 0.2 }} />
        </div>
      </div>
    </section>
  );
