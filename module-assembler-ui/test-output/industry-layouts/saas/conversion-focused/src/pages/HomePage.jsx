/**
 * HomePage - Conversion Focused Layout
 * Business: FlowStack
 * Industry: saas
 * Generated: 2026-01-23T20:54:26.861Z
 *
    ...
    <section style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{ opacity: 0.9 }}>The all-in-one platform that helps teams collaborate, automate, and deliver faster. Join 10,000+ companies already using FlowStack.</p>
        </div>
