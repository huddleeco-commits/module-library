/**
 * AboutPage - Conversion Focused Layout
 */
  ...
  return (
    <div style={{ backgroundColor: COLORS.background || '#FAFAFA' }}>
      ...
      <section style={{
        ...
        <p style={{ fontSize: '20px', opacity: 0.9 }}>Streamline Your Workflow, Amplify Your Results</p>
      </section>
      ...
      <section style={{ padding: '80px 20px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ marginTop: '24px', fontSize: '16px', opacity: 0.7 }}>Proudly serving since 2020</p>
        </div>
      </section>
            ...
            {[
              ...
              <div key={idx} style={{ textAlign: 'center', padding: '24px' }}>
                <div style={{
                  ...
                  {v.icon === 'Heart' && <Heart size={28} color="#6366F1" />}
                  {v.icon === 'Shield' && <Shield size={28} color="#6366F1" />}
                  {v.icon === 'Star' && <Star size={28} color="#6366F1" />}
                  {v.icon === 'Users' && <Users size={28} color="#6366F1" />}
                </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '32px' }}>
              {team.map((member, idx) => (
                <div key={idx} style={{
                  ...
                  <p style={{ color: '#6366F1', fontWeight: '500', marginBottom: '12px' }}>{member.role || member.title}</p>
