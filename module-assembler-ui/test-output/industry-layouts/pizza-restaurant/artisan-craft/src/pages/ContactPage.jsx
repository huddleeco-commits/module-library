/**
 * ContactPage - Artisan Craft Layout
 */
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <a href="tel:(555) 123-4567" style={{
                ...
                <div style={{
                  ...
                  <Phone size={24} color="#E63946" />
                </div>
                <div>
                  <div style={{ fontWeight: '600' }}>Phone</div>
                  <div style={{ opacity: 0.7 }}>(555) 123-4567</div>
                </div>
              </a>

              
              <a href="mailto:hello@testpizzaco.com" style={{
                display: 'flex',
                alignItems: 'center',
                gap: '16px',
                padding: '20px',
                ...
                <div>
                  ...
                  <div style={{ opacity: 0.7 }}>hello@testpizzaco.com</div>
                </div>
              </a>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <MapPin size={24} color="#E63946" />
                </div>
                <div>
                  <div style={{ fontWeight: '600' }}>Address</div>
                  <div style={{ opacity: 0.7 }}>123 Main Street, Austin, TX 78701</div>
                </div>
              </div>
            </div>
          </div>
