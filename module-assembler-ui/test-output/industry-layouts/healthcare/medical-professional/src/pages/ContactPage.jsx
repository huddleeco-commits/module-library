/**
 * ContactPage - Medical Professional Layout
 */
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <a href="tel:(555) 789-CARE" style={{
                ...
                <div>
                  ...
                  <div style={{ opacity: 0.7 }}>(555) 789-CARE</div>
                </div>
              </a>

              
              <a href="mailto:appointments@wellnessmedical-demo.com" style={{
                display: 'flex',
                alignItems: 'center',
                gap: '16px',
                padding: '20px',
                ...
                <div>
                  ...
                  <div style={{ opacity: 0.7 }}>appointments@wellnessmedical-demo.com</div>
                </div>
              </a>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ opacity: 0.7 }}>200 Health Plaza, Boston, MA 02108</div>
                </div>
              </div>
            </div>
          </div>
