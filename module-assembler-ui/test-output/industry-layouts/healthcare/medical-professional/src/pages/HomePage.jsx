 ...
 * Industry: healthcare
 * Generated: 2026-01-23T20:54:26.819Z
 *
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
            <div>
              <div style={{ fontSize: '32px', fontWeight: '700', color: '#0284C7' }}>21+</div>
              <div style={{ fontSize: '14px', opacity: 0.7 }}>Years Experience</div>
            </div>
            <div>
              <div style={{ fontSize: '32px', fontWeight: '700', color: '#0284C7' }}>1000+</div>
        ...
        <div style={{
          ...
          <Building size={100} color="#0284C7" style={{ opacity: 0.2 }} />
        </div>
      </div>
    </section>
  );
