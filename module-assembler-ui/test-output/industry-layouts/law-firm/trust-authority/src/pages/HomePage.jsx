/**
 * HomePage - Trust & Authority Layout
 * Business: Harrison & Associates
 * Industry: law-firm
 * Generated: 2026-01-23T20:54:26.843Z
 *
      ...
      <div style={{
        ...
        <div>
          ...
          <h1 style={{
            ...
            Trusted Legal Counsel for Over 25 Years
          </h1>
          ...
          <p style={{
            ...
            Protecting your rights and fighting for the justice you deserve. Our experienced attorneys are here to guide you through every step.
          </p>
          ...
          <div style={{ display: 'flex', gap: '40px', flexWrap: 'wrap' }}>
            <div>
              <div style={{ fontSize: '32px', fontWeight: '700', color: '#1E3A5F' }}>28+</div>
              <div style={{ fontSize: '14px', opacity: 0.7 }}>Years Experience</div>
            </div>
            <div>
              <div style={{ fontSize: '32px', fontWeight: '700', color: '#1E3A5F' }}>1000+</div>
              <div style={{ fontSize: '14px', opacity: 0.7 }}>Happy Customers</div>
            </div>
            <div>
              <div style={{ fontSize: '32px', fontWeight: '700', color: '#1E3A5F' }}>4.9</div>
        ...
        <div style={{
          ...
          <Building size={100} color="#1E3A5F" style={{ opacity: 0.2 }} />
        </div>
      </div>
    </section>
  );
...
function TestimonialsSection() {
  ...
  return (
    <section style={{ padding: '100px 20px', backgroundColor: '#F8F6F3' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <h2 style={{
          fontSize: 'clamp(28px, 3vw, 36px)',
          fontWeight: '700',
