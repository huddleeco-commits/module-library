/**
 * ContactPage - Trust & Authority Layout
 */
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <a href="tel:(555) 234-5678" style={{
                ...
                <div>
                  ...
                  <div style={{ opacity: 0.7 }}>(555) 234-5678</div>
                </div>
              </a>

              
              <a href="mailto:contact@harrisonlaw-demo.com" style={{
                display: 'flex',
                alignItems: 'center',
                gap: '16px',
                padding: '20px',
                ...
                <div>
                  ...
                  <div style={{ opacity: 0.7 }}>contact@harrisonlaw-demo.com</div>
                </div>
              </a>
              ...
              <div style={{
                ...
                <div>
                  ...
                  <div style={{ opacity: 0.7 }}>100 Legal Plaza, Suite 500, Chicago, IL 60601</div>
                </div>
              </div>
            </div>
          </div>
