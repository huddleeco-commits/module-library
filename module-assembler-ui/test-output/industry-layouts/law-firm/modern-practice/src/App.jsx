      ...
      <div style={{ minHeight: '100vh', backgroundColor: COLORS.background || '#FAFAFA' }}>
        ...
        <footer style={{
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
            <h3 style={{ fontSize: '24px', fontWeight: '700', marginBottom: '16px' }}>Harrison & Associates</h3>
            <p style={{ opacity: 0.7, marginBottom: '24px' }}>Trusted Legal Counsel for Over 25 Years</p>
            <p style={{ fontSize: '14px', opacity: 0.5 }}>
              © 2026 Harrison & Associates. All rights reserved.
            </p>
          </div>
        </footer>
      </div>
