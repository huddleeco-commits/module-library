 ...
 * Business: Test Luxe Salon & Spa
 * Industry: spa-salon
 * Generated: 2026-01-23T20:54:26.830Z
 *
...
function HeroSection() {
  return (
    <section style={{
      minHeight: '85vh',
      background: 'linear-gradient(135deg, #9D8189, #D4AF37)',
      display: 'flex',
      alignItems: 'center',
      ...
      <div style={{ maxWidth: '800px', color: 'white' }}>
        ...
        <p style={{
          ...
          Award-winning stylists and therapeutic treatments in the heart of Beverly Hills
        </p>
...
function TestimonialsSection() {
  ...
  return (
    <section style={{ padding: '100px 20px', backgroundColor: '#faf8f5' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <h2 style={{
          fontSize: 'clamp(28px, 3vw, 36px)',
          fontWeight: '700',
