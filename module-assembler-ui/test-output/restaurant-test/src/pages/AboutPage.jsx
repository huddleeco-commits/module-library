...
const TEAM = [
  {
    "name": "Chef Marco",
    "role": "Executive Chef",
    "bio": "Over 20 years of culinary experience"
  },
  {
    "name": "Sofia",
    "role": "Pastry Chef",
    "bio": "Trained at Le Cordon Bleu"
  },
  {
    "name": "James",
      ...
      <section style={{ padding: '100px 20px' }}>
        <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '18px', lineHeight: 1.8, opacity: 0.8, marginBottom: '24px' }}>
            What began as a small family dream has grown into a beloved neighborhood destination. Our founders believed that great food should be accessible to everyone, prepared with love, and served with warmth.
          </p>
          <p style={{ fontSize: '18px', lineHeight: 1.8, opacity: 0.8 }}>
            Since 2018, we have been crafting memorable dining experiences for our guests. Every dish tells a story, every ingredient is carefully selected, and every guest becomes part of our family.
          </p>
        </div>
      </section>
